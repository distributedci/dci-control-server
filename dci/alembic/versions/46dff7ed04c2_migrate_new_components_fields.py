...
from dci.db.migration_components import get_component_display_name_and_version
        ...
        while True:
            ...
            for c in components:
                if not c.display_name or not c.version:
                    display_name, version = get_component_display_name_and_version(
                        c.name, c.canonical_project_name
                    )
