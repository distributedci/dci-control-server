...
def upgrade():
    ...
    op.create_index(
        ...
        "components",
        ["display_name", "product_id", "topic_id", "type", "version"],
        unique=True,
    ...
    op.create_index(
        ...
        "components",
        ["display_name", "product_id", "type", "version"],
        unique=True,
        postgresql_where=sa.sql.text(
    ...
    op.create_index(
        ...
        "components",
        ["display_name", "product_id", "team_id", "topic_id", "type", "version"],
        unique=True,
        postgresql_where=sa.sql.text(
    ...
    op.create_index(
        ...
        "components",
        ["display_name", "product_id", "team_id", "type", "version"],
        unique=True,
        postgresql_where=sa.sql.text(
