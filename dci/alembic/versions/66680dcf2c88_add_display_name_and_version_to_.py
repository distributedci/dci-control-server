...
def upgrade():
    ...
    op.create_index(
        "active_components_name_topic_id_type_version_team_id_null_key",
        "components",
        ["name", "topic_id", "type", "version"],
        unique=True,
...
def downgrade():
    ...
    op.drop_constraint("name_topic_id_type_team_id_version_unique", "components")
    op.create_unique_constraint(
    ...
    op.drop_index(
        "active_components_name_topic_id_type_version_team_id_null_key", "components"
    )
    op.create_index(
