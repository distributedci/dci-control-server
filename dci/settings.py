...
# S3/minio Store
STORE_S3_AWS_ACCESS_KEY_ID = os.getenv("STORE_S3_AWS_ACCESS_KEY_ID")
STORE_S3_AWS_SECRET_ACCESS_KEY = os.getenv("STORE_S3_AWS_SECRET_ACCESS_KEY")
STORE_S3_AWS_REGION = os.getenv("STORE_S3_AWS_REGION")
STORE_S3_ENDPOINT_URL = os.getenv("STORE_S3_ENDPOINT_URL")
STORE_S3_SIGNATURE_VERSION = os.getenv("STORE_S3_SIGNATURE_VERSION")
