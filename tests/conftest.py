...
@pytest.fixture
def hmac_client_feeder(app, feeder_id, feeder_api_secret):
...
@pytest.fixture
def team_admin_job(hmac_client_admin, rhel_80_topic, rhel_80_component):
    data = {
...
@pytest.fixture
def team1_job(hmac_client_team1, rhel_80_topic, rhel_80_component):
    data = {
        "name": "test",
        "components_ids": [rhel_80_component["id"]],
        "topic_id": rhel_80_topic["id"],
...
# Todo(gvincent): Bellow to clean


@pytest.fixture
def feeder(client_admin, team_admin_id):
    data = {
...
@pytest.fixture
def feeder_id(client_epm, team1_id):
    data = {"name": "feeder_osp", "team_id": team1_id}
    feeder = client_epm.post("/api/v1/feeders", data=data).data
    return str(feeder["feeder"]["id"])


@pytest.fixture
def feeder_api_secret(client_admin, feeder_id):
    api_secret = client_admin.get("/api/v1/feeders/%s" % feeder_id).data
...
@pytest.fixture
def jobstate_user_id(client_user1, team1_job_id):
...
@pytest.fixture
def file_user_id(client_user1, jobstate_user_id, team1_id):
...
@pytest.fixture
def file_job_user_id(client_user1, team1_job_id, team1_id):
...
# todo: gvincent Remove me?
@pytest.fixture
def remoteci_configuration_user_id(client_user1, team1_remoteci_id, rhel_80_topic_id):
    rc = client_user1.post(
        "/api/v1/remotecis/%s/configurations" % team1_remoteci_id,
        data={
            "name": "cname",
