...
from dci.db.migration_components import (
    get_component_display_name_and_version,
)
...
def test_component_migrations_methods():
    components = [
        ...
        },
        {
            ...
            "display_name": "partner/product 14.7.0",
        ...
        },
        {
            ...
            "display_name": "CNF image nrf-expiration 10.1.0",
        ...
        },
        {
            ...
            "version": "d2ebdc12ee3fd9325f501c30a5f3982512a17da7",
        },
        {
    ...
    for component in components:
        assert get_component_display_name_and_version(
            component["name"], component["canonical_project_name"]
        ) == (component["display_name"], component["version"])
