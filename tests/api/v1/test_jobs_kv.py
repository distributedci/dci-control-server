...
def test_add_kv_to_job(hmac_client_team1, components_user_ids, rhel_80_topic_id):
    data = {
...
def test_delete_from_job(hmac_client_team1, components_user_ids, rhel_80_topic_id):
    data = {
        "components": components_user_ids,
        "topic_id": rhel_80_topic_id,
        "name": "my-job-name",
