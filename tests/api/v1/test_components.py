...
def test_components_access_of_other_teams(
    ...
    permissions = admin.get("/api/v1/teams/%s/permissions/components" % team_user_id2)
    ...
    permissions = admin.get("/api/v1/teams/%s/permissions/components" % team_user_id2)
    assert team_user_id == permissions.data["teams"][0]["id"]
    ...
    cat = admin.post(
        "/api/v1/teams/%s/permissions/components" % team_user_id2,
        data={"teams_ids": [team_user_id2, team_user_id]},
    )
    assert cat.status_code == 400
