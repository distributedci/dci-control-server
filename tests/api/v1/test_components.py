...
def test_nrt_get_all_components_with_new_line_in_where(admin, topic_id):
    response = admin.get("/api/v1/topics/%s/components?sort=-created_at&where=name:RHOS-16.2-RHEL-8-20221005.n.1-ASYNC,type:compose,state:active&limit=1&offset=0" % topic_id)
