...
def test_create_jobs(
    hmac_client_team1, components_user_ids, team1_job_id, team1_id, rhel_80_topic_id
):
    data = {
        "comment": "kikoolol",
...
def test_create_jobs_bad_previous_job_id(
    hmac_client_team1, components_user_ids, rhel_80_topic_id
):
    data = {
        "comment": "kikoolol",
        "components": components_user_ids,
...
def test_create_jobs_empty_comment(
    ...
    data = {"components": components_user_ids, "topic_id": rhel_80_topic_id}
...
def test_get_all_jobs(
    client_user1, hmac_client_team1, rhel_80_topic_id, components_user_ids, team1_id
):
    data = {"components_ids": components_user_ids, "topic_id": rhel_80_topic_id}
...
def test_get_all_jobs_with_duplicated_embed(
    hmac_client_team1, rhel_80_component, rhel_80_topic
):
...
def test_get_job_by_id(
    hmac_client_team1, components_user_ids, team1_id, rhel_80_topic_id
):
    job = hmac_client_team1.post(
        "/api/v1/jobs",
        data={"components": components_user_ids, "topic_id": rhel_80_topic_id},
...
def test_get_jobstates_by_job_id_with_embed(
    client_admin, team1_job_id, jobstate_user_id
):
...
def test_get_jobs_with_schedule(
    hmac_client_team1, rhel_80_topic_id, components_user_ids
):
    # schedule a job
...
def test_delete_job_by_id(hmac_client_team1, components_user_ids, rhel_80_topic_id):
    job = hmac_client_team1.post(
        "/api/v1/jobs",
        data={"components": components_user_ids, "topic_id": rhel_80_topic_id},
    )
...
def test_get_job_as_user(
    client_user1, hmac_client_team1, components_user_ids, rhel_80_topic_id
):
    job = hmac_client_team1.post(
        "/api/v1/jobs",
        data={"components": components_user_ids, "topic_id": rhel_80_topic_id},
...
def test_get_files_by_job_id(client_user1, team1_job_id, file_job_user_id):
    # get files from job
...
def test_get_files_by_job_id_as_epm(client_epm, team1_job_id, file_job_user_id):
    # get files from job
