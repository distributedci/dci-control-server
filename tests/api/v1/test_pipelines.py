...
def test_get_pipelines(remoteci_context, topic_user_id, team_user_id):
    for _ in range(3):
...
def test_update_pipeline(user, remoteci_context, topic_user_id, team_user_id):
    pipeline = remoteci_context.post(
        "/api/v1/pipelines",
        data={"name": "pipeline1", "topic_id": topic_user_id, "team_id": team_user_id},
    )
...
def test_delete_pipeline(remoteci_context, topic_user_id, team_user_id):
    pipeline = remoteci_context.post(
        "/api/v1/pipelines",
        data={"name": "pipeline1", "topic_id": topic_user_id, "team_id": team_user_id},
    )
